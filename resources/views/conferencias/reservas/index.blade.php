                    ...
                    <div class="card">
                        <div class="card-body">
                           ...
                           <table class="data-table data-table-feature">
                            ...
                            <th>Nombres</th>
                            <th>Jefe</th>
                            <th>Numero</th><th></th><th></th><th></th><th></th>
                        ...
                        @foreach ($usuarios as $user)
                            ...
                            <td>{{ $user->numero }}</td><td></td><td></td><td></td>
                            <td><a href="{{ route('admin.usuarios.edit', [$user->id]) }}" class="btn btn-warning"><i class="fas fa-edit"></i> Editar</a></td>
                            <td><form style="display:inline" method='POST' action="{{ route('admin.usuarios.update2',[$user->id]) }}">
                                      {!! method_field('PUT') !!}
                                         {!! csrf_field() !!}
