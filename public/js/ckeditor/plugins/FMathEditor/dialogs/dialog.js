        ...
        contents: [
            {
                ...
                elements: [
                    {
                        type: 'html',
                        html: '<iframe id="editorIFrame-' + editor.id + '" style="width:1024px;height:500px" src="'+ CKEDITOR.basePath +'plugins/FMathEditor/editor/onlyEditor.html"></iframe>'
                    }
                ]
            }
        ],
				...
				if(selElem.getName() =='img'){
					...
					if(mathmlEnc!=null && mathmlEnc.length > 16){
						...
						if(mathml.indexOf("<math")==0){
                                                    var editorFrame = document.getElementById('editorIFrame-' + editor.id );
                                                    if(typeof editorFrame.contentWindow.setMathML !== "undefined") {
                                                        editorFrame.contentWindow.setMathML(mathml);
                                                    }else{  // Si aún no se carga el fmath esperar 
